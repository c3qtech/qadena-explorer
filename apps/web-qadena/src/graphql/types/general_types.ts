...
export type ProposalDetailsQuery = { proposal: Array<{ __typename?: 'proposal', title: string, description: string, status?: string | null, content: any, proposer: string, proposalId: number, submitTime: any, proposalType?: string | null, depositEndTime?: any | null, votingStartTime?: any | null, votingEndTime?: any | null }> };
